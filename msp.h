...
void read_IDENT(struct sp_port * multiwii);
void read_STATUS(struct sp_port * multiwii);
void read_RAW_RC(struct sp_port * multiwii);

void send_request(struct sp_port * multiwii, uint8_t code_in);
void send_RAW_RC(struct sp_port * multiwii);
